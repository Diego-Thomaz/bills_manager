...
RSpec.describe Dashboard::SummarizeAccounts::Receivable, type: :service do
  ...
  let!(:total_amount) { accounts_receivable_1.amount + accounts_receivable_2.amount + accounts_receivable_3.amount }
